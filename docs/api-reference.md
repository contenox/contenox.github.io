---
title: contenox/runtime – LLM Backend Management API v3ac621a-dirty
language_tabs:
  - python: Python
language_clients:
  - python: ""
...
<h1 id="contenox-runtime-llm-backend-management-api">contenox/runtime – LLM Backend Management API v3ac621a-dirty</h1>
...
r = requests.get('/hooks/local', headers = headers)
...
<h3 id="lists-local-hooks-supported-by-the-runtime.-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[array_hookproviderservice_LocalHook](#schemaarray_hookproviderservice_localhook)|
|default|Default|Default error response|[ErrorResponse](#schemaerrorresponse)|
...
<h2 id="tocS_array_hookproviderservice_LocalHook">array_hookproviderservice_LocalHook</h2>
<!-- backwards compatibility -->
<a id="schemaarray_hookproviderservice_localhook"></a>
<a id="schema_array_hookproviderservice_LocalHook"></a>
<a id="tocSarray_hookproviderservice_localhook"></a>
<a id="tocsarray_hookproviderservice_localhook"></a>
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|*anonymous*|[[hookproviderservice_LocalHook](#schemahookproviderservice_localhook)]|false|none|none|
...
<h2 id="tocS_chatapi_OpenAIChatResponse">chatapi_OpenAIChatResponse</h2>
<!-- backwards compatibility -->
<a id="schemachatapi_openaichatresponse"></a>
<a id="schema_chatapi_OpenAIChatResponse"></a>
<a id="tocSchatapi_openaichatresponse"></a>
<a id="tocschatapi_openaichatresponse"></a>
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|choices|[taskengine_OpenAIChatResponseChoice](#schemataskengine_openaichatresponsechoice)|true|none|none|
...
|usage|[taskengine_OpenAITokenUsage](#schemataskengine_openaitokenusage)|true|none|none|
...
<h2 id="tocS_hookproviderservice_LocalHook">hookproviderservice_LocalHook</h2>
<!-- backwards compatibility -->
<a id="schemahookproviderservice_localhook"></a>
<a id="schema_hookproviderservice_LocalHook"></a>
<a id="tocShookproviderservice_localhook"></a>
<a id="tocshookproviderservice_localhook"></a>
...
<h2 id="tocS_taskengine_BranchCompose">taskengine_BranchCompose</h2>
<!-- backwards compatibility -->
<a id="schemataskengine_branchcompose"></a>
<a id="schema_taskengine_BranchCompose"></a>
<a id="tocStaskengine_branchcompose"></a>
<a id="tocstaskengine_branchcompose"></a>
...
<h2 id="tocS_taskengine_FunctionCall">taskengine_FunctionCall</h2>
<!-- backwards compatibility -->
<a id="schemataskengine_functioncall"></a>
<a id="schema_taskengine_FunctionCall"></a>
<a id="tocStaskengine_functioncall"></a>
<a id="tocstaskengine_functioncall"></a>
...
<h2 id="tocS_taskengine_OpenAIChatResponseChoice">taskengine_OpenAIChatResponseChoice</h2>
<!-- backwards compatibility -->
<a id="schemataskengine_openaichatresponsechoice"></a>
<a id="schema_taskengine_OpenAIChatResponseChoice"></a>
<a id="tocStaskengine_openaichatresponsechoice"></a>
<a id="tocstaskengine_openaichatresponsechoice"></a>
...
|message|[taskengine_OpenAIChatResponseMessage](#schemataskengine_openaichatresponsemessage)|true|none|none|

<h2 id="tocS_taskengine_OpenAIChatResponseMessage">taskengine_OpenAIChatResponseMessage</h2>
<!-- backwards compatibility -->
<a id="schemataskengine_openaichatresponsemessage"></a>
<a id="schema_taskengine_OpenAIChatResponseMessage"></a>
<a id="tocStaskengine_openaichatresponsemessage"></a>
<a id="tocstaskengine_openaichatresponsemessage"></a>
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|content|string|false|none|Pointer to handle null content for tool calls|
|role|string|true|none|none|
|tool_calls|[taskengine_ToolCall](#schemataskengine_toolcall)|false|none|none|

<h2 id="tocS_taskengine_OpenAITokenUsage">taskengine_OpenAITokenUsage</h2>
<!-- backwards compatibility -->
<a id="schemataskengine_openaitokenusage"></a>
<a id="schema_taskengine_OpenAITokenUsage"></a>
<a id="tocStaskengine_openaitokenusage"></a>
<a id="tocstaskengine_openaitokenusage"></a>
...
|prompt_template|string|true|none|PromptTemplate is the text prompt sent to the LLM.<br>It's Required and only applicable for the prompt_to_string type.<br>Supports template variables from previous task outputs.<br>Example: "Rate the quality from 1-10: {{.input}}"|
...
<h2 id="tocS_taskengine_ToolCall">taskengine_ToolCall</h2>
<!-- backwards compatibility -->
<a id="schemataskengine_toolcall"></a>
<a id="schema_taskengine_ToolCall"></a>
<a id="tocStaskengine_toolcall"></a>
<a id="tocstaskengine_toolcall"></a>
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|function|[taskengine_FunctionCall](#schemataskengine_functioncall)|true|none|none|
|id|string|true|none|none|
|type|string|true|none|none|
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|compose|[taskengine_BranchCompose](#schemataskengine_branchcompose)|false|none|none|
...
|when|string|true|none|When specifies the condition that must be met to follow this branch.<br>Format depends on the task type:<br>- For condition_key: exact string match<br>- For prompt_to_int: numeric comparison (using Operator)|
